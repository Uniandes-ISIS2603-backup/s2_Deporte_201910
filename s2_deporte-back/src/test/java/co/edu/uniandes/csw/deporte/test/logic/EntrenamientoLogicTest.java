...
public class EntrenamientoLogicTest {
    ...
    public void getEntrenamientosTest() {
        List<EntrenamientoEntity> list = entrenamientoLogic.findAll();
    ...
    public void getEntrenamientoTest() throws BusinessLogicException {
        ...
        EntrenamientoEntity newEntity = entrenamientoLogic.find(entity.getId());
    ...
    public void updateEntrenamientoTest() {
        ...
        entrenamientoLogic.update(newEntity);
    ...
    public void deleteEntrenamientoTest() {
        EntrenamientoEntity entity = data.get(0);
        entrenamientoLogic.delete(entity.getId());
